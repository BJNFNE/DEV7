...
How does this works?
-- Антошка3
- Антошка3 checks when you want to enter an Application, if the Disc is valid over the B3_CDMANGER.OBC script with the CheckCDPresent() with the comment "cd ok".
