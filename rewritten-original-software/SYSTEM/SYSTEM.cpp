...
How does this works?
-- Adibou3
- Adibou3 checks when you want to enter an Application, if the Disc is valid over the B3_CDMANGER.OBC script with the CheckCDPresent() with the comment "cd ok".
